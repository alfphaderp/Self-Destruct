' This file is changed every iteration of the loop in main.bat with different x and y coordinates to create an input box with random technical gibberish on a random part of the screen
